...
class PathPlanner(object):
    ...
    def _init_controller(self, opt_dict):
        ...
        args_lateral_dict = {
            ...
            'K_D': 0.01, # Keyur: 0.01  Local_planner: 0.2  Traffic_manager: 0
            'K_I': 1.4, # Keyur: 1.4  Local_planner: 0.07  Traffic_manager: 0.1
            'dt': self._dt}
        args_longitudinal_dict = {
            'K_P': 1.0, # Keyur: 1.0  Local_planner: 1.0  Traffic_manager: 5.0
            'K_D': 0, # Keyur: 0  Local_planner: 0  Traffic_manager: 0
            'K_I': 1, # Keyur: 1  Local_planner: 0.05  Traffic_manager: 0.1
            'dt': self._dt}
