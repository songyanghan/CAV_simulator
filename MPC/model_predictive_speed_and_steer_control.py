...
Q = np.diag([1.0, 1.0, 0.5*100, 0.5])  # state cost matrix
...
# iterative paramter
MAX_ITER = 1  # DEBUG: 3 # Max iteration
...
def pi_2_pi(angle): # forces angle between [-pi, pi]
    while(angle > math.pi):
...
def linear_mpc_control(xref, xbar, x0, dref):
    ...
    #DEBUG prob.solve(solver=cvxpy.ECOS, verbose=False)
