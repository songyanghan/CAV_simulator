...
class World(object):
    ...
    def restart(self):
        ...
        if self.map.name == 'Town05':
            ...
            # spawn_points = [(50, 201), (50, 205), (50, 209), (210, 95), (207, 95), (203.5, 95), (0, -200), (0, -204), (0, -207.5)]

        else:
            spawn_points = self.map.get_spawn_points()
        spawn_points = random.sample(spawn_points, self.num_ego_vehicles)

        for i in range(0, self.num_ego_vehicles): # TODO: Batch this using batch tutorial
...
def game_loop(args):
    ...
    try:
        ...
        agents = [RoamingAgent(player) for player in world.players]
        ...
        while True:
            ...
            # TODO: Figure out synchrony/timestep
